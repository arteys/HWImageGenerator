...
#This part create "lysosomes" with random points in random polygons from unioned polygones
...
# gpd.GeoSeries(polygons_cascaded).plot(color="green", ax=ax)
# plt.savefig('data.png')
# # plt.close()  

# gpd.GeoSeries(circles_cascaded).plot(color="blue", ax=ax)
